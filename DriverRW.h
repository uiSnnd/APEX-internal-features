...
#define ioctl_free_virtual_memory CTL_CODE(FILE_DEVICE_UNKNOWN, 0x222, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
#define ioctl_get_module_base CTL_CODE(FILE_DEVICE_UNKNOWN, 0x225, METHOD_BUFFERED, FILE_SPECIAL_ACCESS) 
...
public:
	...
	void virtual_free(uint64_t address);
